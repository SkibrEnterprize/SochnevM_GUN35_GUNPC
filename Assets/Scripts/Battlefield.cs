...
public class Battlefield : MonoBehaviour
{
    ...
    private void FindCellInDirection(Cell cell, int angle, Cell neighbors)
    {
        ...
        {
            _cellsForMove.Add(neighbors); // добавл€ем в массив дл€ подсветки
        }
    ...
    {
        Vector3 direction = new Vector3(Mathf.Cos(angle * Mathf.Deg2Rad), 0, Mathf.Sin(angle * Mathf.Deg2Rad)); // ”гол 45 градусов       
