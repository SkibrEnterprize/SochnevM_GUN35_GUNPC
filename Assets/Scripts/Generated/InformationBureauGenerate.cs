...
///_______________________________
	public static partial class InformationBureau
	{
		...
		{
			Debug.Log($"<b>[Bureau]</b>: <i>OnQuestChanged({arg0.ToString()}");
		...
		{
			Debug.Log($"<b>[Bureau]</b>: <i>OnCharacterFocused({arg0.ToString()}, </i>{arg1.ToString()}");
		...
		{
			Debug.Log($"<b>[Bureau]</b>: <i>OnShowDialog({arg0.ToString()}, </i>{arg1.ToString()}");
